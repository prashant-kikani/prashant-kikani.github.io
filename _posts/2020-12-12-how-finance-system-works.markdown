...
"Price" comes into play here in every transaction. Now let's see what's the "price" and how it's get decided?
...
For example, Tesla can't price a particular type of car at $100k or $150k. Because then not many people will buy it because other car manufactures are selling <b>similar</b> cars at $35k to $50k price range.
...
Brands like Supreme, Apple use the same supply-demand principle. They generate limited products compared to demand so, prices will be higher and so as their profit margins.
...
The development cost of a $999 priced iPhone is far less than that at around $500 to $600. They can charge that much money because of comparatively high demand of the product.
...
> Economy consists of all of these markets and all of its transactions. All the markets connectively make the economy.
...
We take loans/debts from lenders(like bank) by giving collateral and a promise to pay this money with interest in the future.
...
And as you might have guessed, when the central bank decreases interest rates, borrowing increases, so the in-flow of money starts, spending increases and so income increases of another person.
...
Because if you see, when the central bank prints money, more amount of cash comes to market, but the amount of goods is almost the same!
...
So, the amount of bread which we used to buy for $1, now has a price of $5 or $20. Because the obsolete value of a dollar has been decreased.
...
Credit is good when it’s issued for efficiently allocating resources that produces income and it’s bad when it’s issued for things that don't produce income. Let's take an example of a businessman or an entrepreneur who manages a company.
